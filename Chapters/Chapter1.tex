...
Smart Agriculture PRO está diseñado para realizar monitoreo de viñedos para mejorar la calidad del vino, riego selectivo en campos de golf y control de condiciones en invernaderos, entre otros.
Permite monitorear múltiples parámetros ambientales que involucran una amplia gama de aplicaciones, desde el análisis del desarrollo en crecimiento hasta la observación del clima. Para ello se ha dotado de sensores de temperatura y humedad del aire y del suelo, luminosidad, radiación solar (PAR y UV), velocidad y dirección del viento, precipitaciones, presión atmosférica, humedad de las hojas, distancia y diámetro del fruto o tronco (dendrómetro).
\vspace{1cm}
...
El nuevo nodo RF-M1 es adecuado para tareas de monitoreo simples como parte de una red DropControl o por sí solo. Posee una combinación de entradas que le permite realizar múltiples tareas de monitoreo y almacenarlas en la nube.
\vspace{1cm}

\begin{figure}[h]
	\centering
	\includegraphics[width=.4\textwidth]{./Figures/modulo_dropcontrol.png}
	\caption{Entorno de trabajo de texMaker.}
	\label{fig:texmaker}
\end{figure}
...
\begin{itemize}
  \item Implementacion de un prototipo funcional de hardware de bajo consumo 	
  \item Desarrollo del firmware sobre un sistema operativo de tiempo real
  \item Transmision de la informacion por red celular 
  \item Visualizacion de los datos en una plataforma IoT paga o libre 
